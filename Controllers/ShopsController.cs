...
namespace PosterShop.Controllers
{
    public class ShopsController : Controller
    {
        ...
        public ShopsController(PosterShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Address,Worktime")] Shops shops)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Address,Worktime")] Shops shops)
        {
            if (id != shops.Id)
            {
                return NotFound();
